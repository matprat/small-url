...
class PastesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paste" do
    assert_difference('Paste.count') do
      post pastes_url, params: { paste: { content: @paste.content, expiration_length_in_minutes: @paste.expiration_length_in_minutes, id: @paste.id } }
    end
  ...
  test "should update paste" do
    patch paste_url(@paste), params: { paste: { content: @paste.content, expiration_length_in_minutes: @paste.expiration_length_in_minutes, id: @paste.id } }
